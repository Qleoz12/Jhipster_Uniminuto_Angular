...
import { AeropuertosComponent } from 'app/entities/aeropuertos/aeropuertos.component';
...
describe('Component Tests', () => {
  describe('Aeropuertos Management Component', () => {
    let comp: AeropuertosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AeropuertosComponent, '')
        .compileComponents();
