...
import { VuelosComponent } from 'app/entities/vuelos/vuelos.component';
import { VuelosService } from 'app/entities/vuelos/vuelos.service';
import { Vuelos } from 'app/shared/model/vuelos.model';

describe('Component Tests', () => {
  describe('Vuelos Management Component', () => {
    let comp: VuelosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VuelosComponent, '')
        .compileComponents();
