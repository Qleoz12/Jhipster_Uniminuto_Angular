...
import { AvionesComponent } from 'app/entities/aviones/aviones.component';
import { AvionesService } from 'app/entities/aviones/aviones.service';
import { Aviones } from 'app/shared/model/aviones.model';

describe('Component Tests', () => {
  describe('Aviones Management Component', () => {
    let comp: AvionesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AvionesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.aviones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
